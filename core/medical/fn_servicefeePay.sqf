...
if(life_cash < life_servicefee_val) exitWith
{
    ...
    [[0,format["%1 hat die Service-Gebühr von $%2 bezahlt",name player,[life_servicefee_val] call life_fnc_numberText]],"life_fnc_broadcast",independent,false] spawn life_fnc_MP;
    closeDialog 0;
};
    //SAOK 
