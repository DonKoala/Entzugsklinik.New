...
/*
	...
	Author: Bryan "Tonic" Boardwine edited by M4rc3lloX
...
player setVariable["seklevel", __GETC__(life_seklevel), true];
player setVariable["medlevel", __GETC__(life_medicLevel), true];
player setVariable["donator", __GETC__(life_donator), true];
