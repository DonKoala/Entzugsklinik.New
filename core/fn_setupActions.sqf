...
switch (playerSide) do
{
	...
	case west: {
		...
		life_actions = life_actions + [player addAction["<t color='#BDBDBD'>Barriere klein aufheben</t>",life_fnc_packupmauer,"",0,false,false,"",' _barriersmall = nearestObjects[getPos player,["RoadBarrier_small_F"],8] select 0; !isNil "_barriersmall" && !isNil {(_barriersmall getVariable "item")}']];
