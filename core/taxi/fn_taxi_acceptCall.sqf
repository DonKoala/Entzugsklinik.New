...
hint format ["Du hast den Auftrag von %1 angenommen. Der Fahrgast ist von dir %2 Meter entfernt. Der Fahrgast wurde auf der Map markiert.",name _player,player distance _player];
...
"Taxilocation" setMarkerTextLocal format ["Letzte Position des Auftraggebers %1",name _player];
