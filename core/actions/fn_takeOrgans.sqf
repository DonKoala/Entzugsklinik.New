...
if(!([true,"kidney",1] call life_fnc_handleInv)) exitWith {hint "Du hast dafür keinen Platz mehr!"};//if no room for kidney, you cannot take their kidney, duh, waste not want not
