...
__CONST__(life_donator,parseNumber(_this select 5)); // Donators are back! --> just accessoires!
...
switch(playerSide) do {
	case west: {
		...
		__CONST__(life_seklevel, parseNumber(_this select 10));
