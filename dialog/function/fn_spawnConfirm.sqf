...
if(life_firstSpawn) then {
	...
	execVM "core\TJMS\fn_introTJMS.sqf"; // 45sec.
} else {
	execVM "core\TJMS\fn_introGTA.sqf"; // 10sec.? - We don't want to fuck people with our TJMS intro THAAAAAAT hard in the ass ^^
};
