			...
			case (license_civ_rebel):
			{
				["Rebellen Waffenkammer",
					[	
						...
						["Trixie_XM8_DMR_NB",nil,3500000],	
						["Trixie_XM8_DMR",nil,350000],	
						["Trixie_XM8_SAW_NB",nil,400000],	
						...
						["hlc_rifle_CQBR",nil,320000],									
						["hlc_30rnd_556x45_EPR",nil,5000],	
						["hlc_muzzle_556NATO_KAC",nil,5000],							
						["hlc_rifle_auga1_b",nil,360000],									
						["hlc_30Rnd_556x45_B_AUG",nil,6000],
						["hlc_rifle_auga2_b",nil,360000],									
						["hlc_30Rnd_556x45_B_AUG",nil,6000],	
						["hlc_rifle_auga3_b",nil,360000],									
						["hlc_30Rnd_556x45_B_AUG",nil,6000],							
						["hlc_muzzle_snds_AUG",nil,220000],		
						["hlc_rifle_ak47",nil,280000],
						["hlc_rifle_akm",nil,280000],						
						["hlc_30Rnd_762x39_b_ak",nil,2000],
						["hlc_rifle_rpk",nil,560000],						
						["hlc_45Rnd_762x39_m_rpk",nil,5000],
						["hlc_75Rnd_762x39_m_rpk",nil,9000],
						["hlc_muzzle_762SUP_AK",nil,10000],
						["hlc_rifle_aek971",nil,320000],
						["hlc_rifle_ak74",nil,320000],
						["hlc_rifle_aks74",nil,320000],	
						["hlc_rifle_aks74u",nil,300000],									
						["hlc_30Rnd_545x39_B_AK",nil,5000],
						["hlc_rifle_rpk74n",nil,560000],									
						["hlc_45Rnd_545x39_t_rpk",nil,5000],						
						["hlc_muzzle_545SUP_AK",nil,220000],	
						["hlc_rifle_saiga12k",nil,560000],									
						["hlc_10rnd_12g_slug_S12",nil,5000],							
						["hlc_optic_kobra",nil,220000],
						["HLC_Optic_PSO1",nil,220000],
						["BWA3_G27",nil,300000],
						["BWA3_G28_Assault",nil,300000],							
						["BWA3_20Rnd_762x51_G28",nil,5000],
						["BWA3_G28_Standard",nil,300000],
						["BWA3_10Rnd_762x51_G28",nil,5000],	
						["BWA3_10Rnd_762x51_G28_LR",nil,5000],		
						["BWA3_optic_Aimpoint",nil,220000],
						["BWA3_optic_Shortdot",nil,220000],
						["BWA3_optic_20x50",nil,220000],
						["BWA3_optic_RSAS",nil,220000],
						["BWA3_optic_ZO4x30",nil,220000],
						["BWA3_optic_NSV600",nil,220000],					
						["BWA3_acc_LLM01_flash",nil,220000],
						["BWA3_muzzle_snds_G28",nil,220000],	
						["BWA3_G36K",nil,300000],
						["BWA3_G36",nil,300000],							
			...
			case (license_civ_rebel):
			{
				["Russische Import Waren",
					[
						...
						["rhs_30Rnd_762x39mm",nil,2000],
						["rhs_weap_ak74m_npz",nil,560000],						
						["rhs_weap_ak74m_2mag_npz",nil,320000],
						["rhs_weap_ak74m_plummag_npz",nil,10000],						
						["rhs_30Rnd_545x39_AK",nil,320000],	
						["rhs_acc_ak5",nil,320000],
						["rhs_acc_pbs1",nil,320000],							
						["rhs_weap_svdp_npz",nil,10000],
						["rhs_weap_svds_npz",nil,320000],
